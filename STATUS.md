...
- **版本**：**v0.9.59 待推送发布**（本地 workspace 校验全绿，尚未 push/tag）——BETA-80 修复 v0.9.58 真机反馈的 Scoutd 服务启动失败问题。仓库：[github.com/huibinma/Scout](https://github.com/huibinma/Scout)（public，完整历史归档于 private 的 `huibinma/scout-archive`）。
